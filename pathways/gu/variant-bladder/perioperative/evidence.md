...
|---|---|---|
| MIBC with micropapillary, nested, plasmacytoid, neuroendocrine/small-cell, sarcomatoid, or extensive squamous/glandular differentiation | Confirm on expert GU-pathology review before choosing a variant-specific pathway. | Do not treat “variant histology” as a single predictive category. |
| Resectable small-cell/neuroendocrine urothelial carcinoma | The strongest subtype-specific perioperative evidence is retrospective or phase 2. | Plan systemic platinum-based treatment and local consolidation in a multidisciplinary setting. |
| Other variants or differentiation | Data are heterogeneous and mostly retrospective. | Avoid a one-size-fits-all neoadjuvant or adjuvant claim. |

## Standard options

| Clinical context | Option | Key inclusion | Typical course |
|---|---|---|---|
| Resectable small-cell/neuroendocrine urothelial carcinoma | Platinum-based, often neuroendocrine-directed systemic therapy before local consolidation | Match fitness and pathology to the phase 2/retrospective evidence. | Multidisciplinary regimen and local-treatment plan. |
...
|---|---|---|---|---|---|---|
| [MD Anderson small-cell cohort](https://pmc.ncbi.nlm.nih.gov/articles/PMC3815632/) | Resectable small-cell component, ≤cT4aN0M0 | Neoadjuvant chemotherapy then cystectomy | Initial surgery | Retrospective survival/pathologic comparison | Downstaging to ≤pT1N0: 62% vs 9%; median OS 159.5 vs 18.3 months. | Retrospective, subtype-specific, and not a randomized comparison. |
| [Small-cell phase 2](https://pmc.ncbi.nlm.nih.gov/articles/PMC4879720/) | Thirty pathology-confirmed small-cell urothelial cancers; resectable subgroup ≤cT4aN0M0 | Alternating ifosfamide/doxorubicin and etoposide/cisplatin before cystectomy | No concurrent comparator | Pathologic downstaging | In resectable patients, 14/18 downstaged to ≤pT1N0M0; cT2N0M0 5-year OS 80%. | Single-arm, small study; not proof against GC or ddMVAC. |
| [Variant-histology meta-analysis](https://pmc.ncbi.nlm.nih.gov/articles/PMC9333064/) | Eighteen observational neoadjuvant-chemotherapy reports | Neoadjuvant chemotherapy | No neoadjuvant chemotherapy | Cancer-specific and overall survival | Pooled OS HR 0.74; subgroup associations varied by subtype. | Intermediate-to-high risk of bias; not a patient-level or uniform-variant estimate. |

## Biomarkers

| Feature | Role now | Practical boundary |
|---|---|---|
| Expert GU-pathology review | Confirms variant and proportion | Changes diagnostic confidence; does not automatically determine a single regimen. |
| Genomic testing | Trial and hereditary-risk assessment | No validated molecular selector for perioperative therapy across variants in this source set. |

## Upcoming trial results

No named prospective variant-specific result was identified that is likely to change care. Do not use general-MIBC perioperative trials as variant-specific efficacy evidence without a reported subtype analysis.
...
- [Siefker-Radtke et al. (2013). Small-cell urothelial cancer neoadjuvant chemotherapy. *European Urology*. PMID: 22564397](https://pmc.ncbi.nlm.nih.gov/articles/PMC3815632/)
