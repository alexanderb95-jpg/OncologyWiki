...
|---|---|---|
| Clinical stage I seminoma | Pure seminoma after orchiectomy, normalizing markers, and no metastasis on conventional staging. | Elevated AFP should be managed as nonseminoma/mixed GCT, not pure seminoma. |
| Clinical stage I NSGCT | Negative conventional staging with normalized post-orchiectomy markers. | Persistently rising AFP or hCG is occult systemic disease, not a surveillance/adjuvant population. |
| Shared requirements | Fertility preservation, contralateral testis assessment, pathology review, and follow-up feasibility. | IGCCCG prognosis groups apply to metastatic disease, not stage I. |

## Standard options

| Clinical context | Option | Key inclusion | Typical course |
|---|---|---|---|
| Stage I seminoma | Surveillance | Feasible cross-sectional imaging and marker follow-up. | Guideline-directed surveillance. |
| Stage I seminoma selecting adjuvant therapy | One carboplatin AUC 7 cycle | Recurrence-reduction option after shared decision-making. | One cycle. |
...
|---|---|---|---|---|---|---|
| [TE19/EORTC 30982](https://pubmed.ncbi.nlm.nih.gov/21282539/), N=1,447 | Unselected stage I seminoma | Carboplatin AUC 7 | Adjuvant radiotherapy | Relapse-free rate | Five-year relapse-free rate 94.7% vs 96.0%; HR 1.25 (90% CI 0.83–1.89). | Does not compare carboplatin with surveillance or prove survival benefit. |
| [TRISST](https://pmc.ncbi.nlm.nih.gov/articles/PMC7614664/), N=669 | Stage I seminoma, normal AFP/hCG, no planned adjuvant therapy | MRI surveillance or reduced scan schedule | CT surveillance or standard scan schedule | Advanced relapse | Six-year advanced relapse 0.6% MRI vs 2.6% CT; five-year OS ≥98% in every arm. | Imaging/surveillance trial, not adjuvant-treatment comparison. |
| [AH 01/94](https://pubmed.ncbi.nlm.nih.gov/18458040/), N=382 | Unselected stage I NSGCT | One BEP cycle | RPLND | Two-year recurrence-free survival | 99.46% vs 91.87%. | Does not compare either strategy with surveillance; RPLND outcomes vary by center expertise. |

## Biomarkers

| Feature | Role now | Practical boundary |
|---|---|---|
| Lymphovascular invasion in NSGCT | Relapse-risk stratification | EAU estimates relapse about 15% without LVI and up to 50% with LVI; shared decision, not a survival mandate. |
| Tumor size and rete testis invasion in seminoma | Prognostic discussion only | AUA advises against using these as a stand-alone management rule. |
| miR-371a-3p | Investigational surveillance biomarker | Do not replace imaging or standard markers outside a study. |

## Upcoming trial results

| Trial or publication | Why it may change care | Evidence status |
|---|---|---|
| [MAGESTIC](https://clinicaltrials.gov/study/NCT06060873) | Tests miR-371 in stage I surveillance and suspected regional disease. | Recruiting phase 2; no treatment-changing outcomes. |
| [Belge et al.](https://pubmed.ncbi.nlm.nih.gov/37967143/) | Prospective observational miR-371 surveillance cohort may inform future relapse detection. | Peer-reviewed observational report; not a treatment-selection standard. |
...
- [Oliver et al. (2011). TE19/EORTC 30982. *Journal of Clinical Oncology*. PMID: 21282539](https://pubmed.ncbi.nlm.nih.gov/21282539/)
- [Joffe et al. (2022). TRISST. *Journal of Clinical Oncology*.](https://pmc.ncbi.nlm.nih.gov/articles/PMC7614664/)
