...
|---|---|---|
| Resectable MIBC planned for radical cystectomy and pelvic lymph-node dissection | Confirm cT/cN stage, histology, obstruction and drainage needs, renal function, hearing, neuropathy, performance status, and surgical candidacy. | Reassess cisplatin eligibility after relief of tumor-related obstruction when feasible. |
| Cisplatin-eligible MIBC | NIAGARA and EV-304 evaluated distinct perioperative sequences. | Do not substitute adjuvant-only results for a preoperative strategy. |
| Cisplatin-ineligible or declining cisplatin | EV-303 evaluated perioperative EV plus pembrolizumab. | Not direct evidence for unresectable/metastatic disease or bladder preservation. |

## Standard options

| Clinical context | Option | Key inclusion | Typical course |
|---|---|---|---|
| Cisplatin-eligible, resectable MIBC | Perioperative durvalumab plus gemcitabine/cisplatin | NIAGARA-type eligibility. | Neoadjuvant durvalumab plus GC ×4 → cystectomy → adjuvant durvalumab ×8. |
| Cisplatin-eligible, resectable MIBC | Perioperative EV plus pembrolizumab | EV-304-type eligibility. | Neoadjuvant EV plus pembrolizumab ×4 → cystectomy → adjuvant EV plus pembrolizumab. |
...
|---|---|---|---|---|---|---|
| [EV-303 / KEYNOTE-905](https://pubmed.ncbi.nlm.nih.gov/41707170/), N=344 | Cisplatin-ineligible or declining MIBC planned for RC+PLND | Neoadjuvant EV 1.25 mg/kg days 1,8 plus pembrolizumab 200 mg every 3 weeks ×3 → RC+PLND → adjuvant EV ×6 plus pembrolizumab | RC+PLND alone | Event-free survival | Two-year EFS 74.7% vs 39.4%; two-year OS 79.7% vs 63.1%; EFS HR 0.40; OS HR 0.50. | Specific cisplatin-ineligible/declining population; perioperative, not adjuvant-only, strategy. |
| [EV-304 / KEYNOTE-B15](https://pubmed.ncbi.nlm.nih.gov/42485627/), N=808 | Cisplatin-eligible MIBC | Neoadjuvant EV plus pembrolizumab ×4 → RC+PLND → adjuvant EV plus pembrolizumab | Neoadjuvant GC ×4 → RC+PLND | Event-free survival | Two-year EFS 79.4% vs 66.2%; two-year OS 86.9% vs 81.3%; EFS HR 0.53; OS HR 0.65. | Comparator is neoadjuvant GC, not surgery alone. |
| [NIAGARA](https://pubmed.ncbi.nlm.nih.gov/39282910/), N=1,063 | Cisplatin-eligible MIBC | Neoadjuvant durvalumab plus GC ×4 → RC → adjuvant durvalumab ×8 | Neoadjuvant GC ×4 → RC | Event-free survival | 24-month EFS 67.8% vs 59.8%; 24-month OS 82.2% vs 75.2%; EFS HR 0.68; OS HR 0.75. | Perioperative anti-PD-L1 strategy; does not isolate the contribution of neoadjuvant versus adjuvant durvalumab. |

## Biomarkers

| Marker or feature | Role now | Practical boundary |
|---|---|---|
| Cisplatin eligibility | Regimen-selection factor | Reassess renal function after obstruction relief; do not infer eligibility from one pre-drainage value alone. |
| Histology and variant features | Pathology review and multidisciplinary planning | Variant-specific efficacy for these newer perioperative regimens was not established in the retrieved trials. |
| ctDNA | Investigational for selecting neoadjuvant treatment | Do not use it to omit curative-intent local therapy outside a protocol. |

## Upcoming trial results

| Trial or publication | Why it may change care | Evidence status |
|---|---|---|
| [EV-304 / KEYNOTE-B15](https://pubmed.ncbi.nlm.nih.gov/42485627/) longer follow-up | Clarifies durability and postoperative treatment completion for a perioperative EV plus pembrolizumab strategy against GC. | Peer-reviewed report; continued follow-up. |
| [NIAGARA](https://pubmed.ncbi.nlm.nih.gov/39282910/) longer follow-up | Clarifies durability of the perioperative durvalumab plus GC result. | Peer-reviewed phase 3 report; continued follow-up. |

## Toxicity

| Regimen and comparator | Trial-level safety outcomes | Selected named toxicities | Counseling focus |
|---|---|---|---|
| Perioperative EV plus pembrolizumab, EV-303 | Grade ≥3 AEs 71.3% vs 45.9%. | Named-event percentages were not extracted from the retrieved primary source set. | Promptly report rash, neuropathy, vision changes, thirst/polyuria, or immune-toxicity symptoms; assess postoperative recovery before adjuvant dosing. |
