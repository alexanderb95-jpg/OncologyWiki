...
- Counseling: For radiotherapy plus long-course ADT, EORTC 22961 showed lower 5-year mortality with 3 years vs 6 months of androgen suppression after radiotherapy. In STAMPEDE-like very-high-risk M0 disease, 6-year metastasis-free survival was about 82% vs 69% with ADT alone (MFS HR 0.53 vs ADT alone; OS HR 0.60 vs ADT alone) when abiraterone was added to ADT. These results apply to defined trial populations, not every high-risk localized patient.
...
- Decision: *** selects surgery / radiotherapy plus ADT / radiotherapy plus ADT with abiraterone-prednisolone / clinical-trial evaluation.
- Labs/NGS: PSA ***, testosterone ***, CBC/CMP ***; germline testing ***; Decipher *** only if it will inform a trial or documented decision.
- Procedures: *** radiation-oncology, urologic-oncology, and multidisciplinary review.
- Medications: *** ADT and supportive bone/metabolic-health plan.
- Follow-up: *** PSA, testosterone, treatment-toxicity, bone-health, and imaging follow-up.
